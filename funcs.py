...
def insert_cells(lines: list, cells: list) -> list:
...
def get_cell_names(cells: list) -> list:
    cell_names = list()
...
def check_cells(lib_cells: list, user_cells: list) -> list:
    ...
    for cell in user_cells:
        if cell not in lib_cells_string:
            print(f"Warning: cell for deleting {cell} not found in source Liberty! It will be skipped...\n")
